...
// --- ✅ 2. تصحيح مسار استيراد AppContext ---
import { useAppContext } from '../context/AppContext';


// --- مكون النافذة المنبثقة للإرشادات (مدمج لسهولة التعديل) ---
            ...
            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                <div className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
                    <h4 className="font-semibold text-lg flex items-center gap-2 text-slate-800 dark:text-slate-200">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" fill="#F0F0F0"/><path d="M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2Z" stroke="#38BDF8" strokeWidth="2"/><path d="M8 8L16 16" stroke="#F44336" strokeWidth="2" strokeLinecap="round"/><path d="M16 8L8 16" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round"/></svg>
                        لهواتف آيفون (متصفح سفاري)
                    </h4>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
                    <h4 className="font-semibold text-lg flex items-center gap-2 text-slate-800 dark:text-slate-200">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="#4A4A4A" strokeWidth="2"/><circle cx="12" cy="12" r="4" fill="#4285F4"/><path d="M12 2A10 10 0 0 1 20.66 7.34L12 12V2Z" fill="#EA4335"/><path d="M2 12A10 10 0 0 1 7.34 3.34L12 12H2Z" fill="#FBBC05"/><path d="M12 22A10 10 0 0 1 3.34 16.66L12 12V22Z" fill="#34A853"/></svg>
                        لهواتف أندرويد (متصفح كروم)
                    </h4>
                    <ol className="list-decimal list-inside mt-2 space-y-2 text-slate-600 dark:text-slate-300">
