...
const PageRouter = () => {
    ...
    // ✅ استدعاء بيانات SEO حسب الصفحة الحالية
    const currentSEO = getSEOData(page);
    const currentURL = `https://stellarspeak.online${page !== 'dashboard' ? `?page=${page}` : ''}`;
