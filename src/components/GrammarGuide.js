...
import { BookText, Search, ChevronDown, BookCopy } from 'lucide-react';
    ...
    return (
        <div className="p-4 md:p-8 animate-fade-in z-10 relative max-w-4xl mx-auto">
            ...
            <div
                ...
                className="mb-8 p-5 bg-gradient-to-r from-sky-500 to-indigo-500 text-white rounded-2xl shadow-lg flex items-center justify-between cursor-pointer hover:scale-105 transition-transform duration-300"
            >
                <div className="flex items-center gap-4">
                    <BookCopy size={32} />
                    <div>
                        <h2 className="font-bold text-xl">قائمة الأفعال الكاملة</h2>
                        <p className="text-sm opacity-90">تصفح قائمة الأفعال المنتظمة وغير المنتظمة مع خاصية البحث.</p>
                    </div>
                </div>
