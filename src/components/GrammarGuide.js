  ...
  return (
    <div className="p-4 md:p-8 animate-fade-in z-10 relative max-w-4xl mx-auto">
      ...
      <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div
          onClick={() => handlePageChange('idioms')}
          className="p-5 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-2xl shadow-lg flex items-center justify-between cursor-pointer hover:scale-105 transition-transform duration-300"
        >
          <div className="flex items-center gap-4">
