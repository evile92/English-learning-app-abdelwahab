    ...
    return (
        <div className="p-4 md:p-8 animate-fade-in z-10 relative max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-slate-600 dark:text-slate-300 mt-2">مرجعك لمجموعات الكلمات الشائعة حسب الفئة.</p>
            </div>

            <div className="space-y-8">
                {vocabularyCategories.map((category) => (
                    <div key={category.title} className="bg-white dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl shadow-lg">
