            ...
            >
                <button
                    ...
                    className={`
                        ...
                        ${isDarkMode ? 'shadow-lg' : 'shadow-lg shadow-sky-200/50'}
                        ${isLocked 
                            ? 'grayscale cursor-not-allowed opacity-70' 
                            : 'hover:scale-110 hover:shadow-2xl'
                        }
                        ${isActiveLevel 
                            ? `ring-4 ${isDarkMode ? 'ring-sky-400 ring-offset-slate-900' : 'ring-white/80 ring-offset-sky-100'} ring-offset-4 animate-pulse-slow` 
                            : ''
                        }
                    `}
                >
            ...
            <div className="md:hidden w-full h-full relative">
                <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 400 650" preserveAspectRatio="none">
                    ...
                    <path 
                        ...
                        stroke={isDarkMode ? "url(#pathGradientMobile)" : "rgba(100, 116, 139, 0.3)"}
                        strokeWidth={isDarkMode ? "3" : "2"}
                        fill="none" 
                        strokeDasharray={isDarkMode ? "10 7" : "5 5"}
            ...
            <div className="hidden md:block w-full h-full relative">
                 <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1000 500" preserveAspectRatio="none">
                    ...
                    <path 
                        ...
                        stroke={isDarkMode ? "url(#pathGradientDesktop)" : "rgba(100, 116, 139, 0.3)"}
                        strokeWidth={isDarkMode ? "4" : "3"}
                        fill="none"
                        strokeDasharray={isDarkMode ? "15 10" : "8 8"}
