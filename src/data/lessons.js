...
export const lessonTitles = {
  A1: [ "The Alphabet & Greetings", "Verb 'to be' (am, is, are)", "Subject Pronouns", "Numbers (1-20) and Age", "Countries & Nationalities", "Singular & Plural Nouns", "Articles (a, an, a)", "This, That, These, Those", "Possessive Adjectives", "Present Simple (I, You, We, They)", "Present Simple (He, She, It)", "Question Words", "Adjectives", "Prepositions of Place (in, on, at)", "Telling the Time", "'There is' & 'There are'", "'Can' for Ability", "'Have got' for Possession", "Family Members", "Food and Drink", "Present Continuous", "Countable & Uncountable Nouns", "'Some' and 'Any'", "Adverbs of Frequency", "Simple Past (Verb 'to be')", "Simple Past (Regular Verbs)", "Simple Past (Irregular Verbs)", "Object Pronouns", "'Like' + Verb-ing", "A1 Level Review" ],
  A2: [ "Present Simple vs. Present Continuous", "Past Simple Review (Irregular Verbs)", "Past Continuous", "Past Simple vs. Past Continuous", "Present Perfect (Introduction)", "Present Perfect with 'ever' and 'never'", "Present Perfect with 'just', 'already', 'yet'", "Present Perfect vs. Past Simple", "Future with 'going to'", "Present Continuous for Future Arrangements", "Future with 'will'", "Comparatives", "Superlatives", "Adverbs of Manner", "Modals of Obligation (must, have to)", "Modals of Advice (should)", "Quantifiers (much, many, a lot of)", "Quantifiers (a little, a few)", "First Conditional", "Prepositions of Movement", "'be like' for descriptions", "Giving Directions", "Describing People (Appearance)", "Describing People (Personality)", "Phrasal Verbs (Introduction)", "Health and Sickness", "Articles (a/an, the, no article)", "Relative Clauses (who, which, that)", "Making Suggestions", "A2 Level Review" ],
  B1: [ "Present Perfect Continuous", "Past Perfect", "Past Perfect Continuous", "Future Continuous & Perfect", "Second Conditional", "Relative Clauses", "Reported Speech", "Gerunds & Infinitivities", "Modals for Speculation", "Passive Voice", "Question Tags", "So / Such", "Enough / Too with Adjectives", "Wish / If only", "Causative Form (have/get)", "Social Issues", "Environment & Climate", "Culture and Arts", "News and Media", "Relationships", "Education and Learning", "World Travel", "Historical Events", "Advanced Technology", "Lifestyle and Health", "Review: B1 Grammar Part 1", "Review: B1 Grammar Part 2", "Review: B1 Vocabulary Part 1", "Review: B1 Vocabulary Part 2", "Final B1 Test" ],
...
// --- ✅ بداية التعديل: إضافة أيقونات كرتونية للوضع النهاري ---
export const initialLevels = {
  A1: { name: "كوكب الأساسيات", icon: "A1", iconLight: "https://www.svgrepo.com/show/493721/planet-saturn.svg", lessons: 30, color: "from-sky-500 to-indigo-500" },
  A2: { name: "قمر البناء", icon: "A2", iconLight: "https://www.svgrepo.com/show/493717/planet-jupiter.svg", lessons: 30, color: "from-teal-400 to-cyan-500" },
  B1: { name: "سديم المتوسطين", icon: "B1", iconLight: "https://www.svgrepo.com/show/493719/planet-neptune.svg", lessons: 30, color: "from-amber-400 to-orange-500" },
  B2: { name: "مجرة الطلاقة", icon: "B2", iconLight: "https://www.svgrepo.com/show/493722/planet-uranus.svg", lessons: 30, color: "from-orange-500 to-red-600" },
  C1: { name: "سديم الحكمة", icon: "C1", iconLight: "https://www.svgrepo.com/show/493715/planet-earth.svg", lessons: 30, color: "from-purple-600 to-indigo-700" },
};
// --- نهاية التعديل ---
