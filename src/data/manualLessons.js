...
export const manualLessonsContent = {
  ...
  "A1-1": {
    explanation: {
      en: "The English alphabet has 26 letters, each with a specific sound. Learning these is the first step to reading and writing. Greetings are polite words we use to start a conversation, like 'hello' for starting and 'goodbye' for ending. It's important to know them for daily communication.",
      ar: "تحتوي الأبجدية الإنجليزية على 26 حرفًا، لكل منها صوت محدد. تعلمها هو الخطوة الأولى للقراءة والكتابة. التحيات هي كلمات مهذبة نستخدمها لبدء محادثة، مثل \"hello\" للبدء و \"goodbye\" للإنهاء. من المهم معرفتها للتواصل اليومي."
    },
    examples: [
      "A is for Apple. - حرف A لكلمة Apple (تفاحة).",
      "Hello, my name is Fatima. - مرحباً، اسمي فاطمة.",
  ...
  "A1-2": {
    explanation: {
      ...
      ar: "فعل \"to be\" أساسي جداً في اللغة الإنجليزية. نستخدمه لوصف هوية شخص ما، مهنته، أو مشاعره. يتغير شكله حسب الفاعل: \"I am\" ، \"he/she/it is\" ، و \"we/you/they are\". يساعدنا هذا الفعل في بناء جمل وصفية بسيطة."
    },
    examples: [
      "I am a student. - أنا طالب.", "She is a doctor. - هي طبيبة.", "He is happy. - هو سعيد.", "We are from Morocco. - نحن من المغرب.", "They are friends. - هم أصدقاء."
    ]
  },
  "A1-3": {
    explanation: {
      ...
      ar: "تحل ضمائر الفاعل محل الأسماء لتجنب التكرار وجعل الجمل أكثر سلاسة. هي الكلمات التي تقوم بالفعل في الجملة. الضمائر الأساسية هي I, you, he, she, it, we, they. استخدامها بشكل صحيح هو مفتاح تكوين جمل واضحة."
    },
    examples: [
      "I like tea. - أنا أحب الشاي.", "You speak English well. - أنت تتحدث الإنجليزية جيداً.", "He lives in London. - هو يعيش في لندن.", "She works in a school. - هي تعمل في مدرسة.", "We play football on Saturdays. - نحن نلعب كرة القدم أيام السبت."
    ]
  },
  "A1-4": {
    explanation: {
      ...
      ar: "الأرقام ضرورية للحياة اليومية، مثل العد والتسوق وإخبار الوقت. سنتعلم الأرقام من واحد إلى عشرين. للحديث عن العمر، نستخدم فعل \"to be\" متبوعًا بالرقم وعبارة \"years old\". السؤال \"How old are you?\" شائع جدًا."
    },
    examples: [
      "I have three books. - لدي ثلاثة كتب.", "She has two sisters. - لديها أختان.", "He is ten years old. - هو يبلغ من العمر عشر سنوات.", "There are seven days in a week. - يوجد سبعة أيام في الأسبوع.", "How old are you? I am nineteen. - كم عمرك؟ عمري تسعة عشر عامًا."
    ]
  },
  "A1-5": {
    explanation: {
      ...
      ar: "للحديث عن المكان الذي أتيت منه، تستخدم اسم البلد. لوصف أصلك كصفة، تستخدم الجنسية. نسأل \"?Where are you from\" لمعرفة بلد شخص ما. الإجابة تكون \"...I am from\" متبوعة باسم البلد."
    },
    examples: [
      "I am from Egypt. I am Egyptian. - أنا من مصر. أنا مصري.", "He is from France. He is French. - هو من فرنسا. هو فرنسي.", "They are from Japan. They are Japanese. - هم من اليابان. هم يابانيون.", "My teacher is from Canada. She is Canadian. - معلمتي من كندا. هي كندية.", "Where are you from? - من أي بلد أنت؟"
    ]
  },
  "A1-6": {
    explanation: {
      ...
      ar: "الاسم هو كلمة لشخص أو مكان أو شيء. الاسم المفرد يشير إلى واحد، بينما الاسم الجمع يشير إلى أكثر من واحد. تتكون معظم أسماء الجمع بإضافة \"-s\" في نهاية الاسم المفرد. ومع ذلك، بعض الأسماء لها أشكال جمع غير منتظمة."
    },
    examples: [
      "one book, two books. - كتاب واحد، كتابان.", "a car, many cars. - سيارة واحدة، سيارات عديدة.", "one man, two men. - رجل واحد، رجلان.", "a child, three children. - طفل واحد، ثلاثة أطفال.", "She has a cat and two dogs. - لديها قطة وكلبان."
    ]
  },
  "A1-7": {
    explanation: {
      ...
      ar: "أدوات التعريف والتنكير هي كلمات تحدد الاسم كمعروف أو غير معروف. \"A\" و \"an\" هما أدوات تنكير تستخدمان لاسم عام (\"a\" قبل صوت ساكن، \"an\" قبل صوت متحرك). \"The\" هي أداة تعريف تستخدم لاسم محدد يعرفه كل من المتحدث والمستمع."
    },
    examples: [
      "I see a car. The car is red. - أرى سيارة. السيارة حمراء.", "She is an engineer. - هي مهندسة.", "He is reading a book. - هو يقرأ كتابًا.", "The sun is very bright today. - الشمس ساطعة جداً اليوم.", "Can you pass me the salt, please? - هل يمكنك تمرير الملح لي من فضلك؟"
    ]
  },
  "A1-8": {
    explanation: {
      ...
      ar: "هذه الكلمات هي ضمائر وصفات إشارة، تستخدم للإشارة إلى أشخاص أو أشياء محددة. نستخدم \"this\" (مفرد) و \"these\" (جمع) للأشياء القريبة. نستخدم \"that\" (مفرد) و \"those\" (جمع) للأشياء البعيدة."
    },
    examples: [
      "This is my phone. (near) - هذا هاتفي. (قريب)", "That is your house. (far) - ذلك منزلك. (بعيد)", "These apples are delicious. (near) - هذا التفاح لذيذ. (قريب)", "Those cars are expensive. (far) - تلك السيارات باهظة الثمن. (بعيد)", "I like this shirt. - يعجبني هذا القميص."
    ]
  },
  "A1-9": {
    explanation: {
      ...
      ar: "توضح صفات الملكية من يملك الشيء أو إلى من ينتمي. هي: my, your, his, her, its, our, their. توضع دائمًا قبل الاسم لوصفه. لا تتغير سواء كان الاسم مفردًا أو جمعًا."
    },
    examples: [
      "This is my bag. - هذه حقيبتي.", "What is your name? - ما هو اسمك؟", "His car is new. - سيارته جديدة.", "Her dress is blue. - فستانها أزرق.", "Their house is very big. - منزلهم كبير جداً."
    ]
  },
  "A1-10": {
    explanation: {
      ...
      ar: "يستخدم زمن المضارع البسيط للتعبير عن العادات، الروتين، والحقائق. مع الفاعل \"I\", \"you\", \"we\", و \"they\"، نستخدم الصيغة الأساسية للفعل. لتكوين جملة منفية، نستخدم \"do not\" (أو don't). للأسئلة، نبدأ بـ \"Do\"."
    },
    examples: [
      "I work in an office. - أنا أعمل في مكتب.", "You speak Arabic. - أنت تتحدث العربية.", "We live in a small city. - نحن نعيش في مدينة صغيرة.", "They don't like cold weather. - هم لا يحبون الطقس البارد.", "Do you play basketball? - هل تلعب كرة السلة؟"
    ]
  },
  "A1-11": {
    explanation: {
      ...
      ar: "عند استخدام المضارع البسيط مع \"he\", \"she\", أو \"it\"، نضيف \"-s\" أو \"-es\" إلى نهاية الفعل الأساسي. بالنسبة للجمل المنفية، نستخدم \"does not\" (أو doesn't) والفعل الأساسي. للأسئلة، نبدأ بـ \"Does\" متبوعة بالفاعل والفعل الأساسي."
    },
    examples: [
      "He works at the hospital. - هو يعمل في المستشفى.", "She speaks three languages. - هي تتحدث ثلاث لغات.", "It rains a lot here in winter. - إنها تمطر كثيراً هنا في الشتاء.", "He doesn't watch TV. - هو لا يشاهد التلفاز.", "Does she live near here? - هل هي تعيش بالقرب من هنا؟"
    ]
  },
  "A1-12": {
    explanation: {
      ...
      ar: "تُستخدم كلمات الاستفهام، المعروفة أيضًا بكلمات WH، لطلب معلومات محددة. الكلمات الرئيسية هي: What (للأشياء)، Where (للأماكن)، When (للزمن)، Who (للأشخاص)، Why (للأسباب)، و How (للطريقة). تأتي عادة في بداية السؤال."
    },
    examples: [
      "What is your job? - ما هي وظيفتك؟", "Where do you live? - أين تعيش؟", "When is the party? - متى الحفلة؟", "Who is your teacher? - من هو معلمك؟", "Why are you late? - لماذا أنت متأخر؟"
    ]
  },
  "A1-13": {
    explanation: {
      ...
      ar: "الصفات هي كلمات تصف الأسماء (أشخاص، أماكن، أشياء). في اللغة الإنجليزية، تأتي الصفة عادة قبل الاسم الذي تصفه. لا يتغير شكل الصفات مع الأسماء المفردة أو الجمع. تساعد الصفات في جعل جملنا أكثر تفصيلاً وإثارة للاهتمام."
    },
    examples: [
      "She has a beautiful dress. - لديها فستان جميل.", "He is a tall man. - هو رجل طويل.", "The test was easy. - كان الاختبار سهلاً.", "They live in a big house. - هم يعيشون في منزل كبير.", "I bought a red car. - اشتريت سيارة حمراء."
    ]
  },
  "A1-14": {
    explanation: {
      ...
      ar: "حروف الجر المكانية تخبرنا بموقع شيء ما. تُستخدم \"In\" للمساحات المغلقة أو المناطق الكبيرة (في صندوق، في مدينة). تُستخدم \"On\" للأسطح (على الطاولة، على الحائط). تُستخدم \"At\" لنقاط أو مواقع محددة (عند محطة الحافلات، في المدرسة)."
    },
    examples: [
      "The keys are in the bag. - المفاتيح في الحقيبة.", "The book is on the desk. - الكتاب على المكتب.", "I will meet you at the airport. - سأقابلك في المطار.", "She lives in London. - هي تعيش في لندن.", "There is a picture on the wall. - توجد صورة على الحائط."
    ]
  },
  "A1-15": {
    explanation: {
      ...
      ar: "للسؤال عن الوقت، تقول \"?What time is it\". يمكنك الإجابة بطريقتين: قول الساعة ثم الدقائق (مثال: 7:45 - \"سبعة وخمسة وأربعون دقيقة\")، أو قول الدقائق بعد أو قبل الساعة (مثال: 7:15 - \"السابعة والربع\"). نستخدم \"o'clock\" للساعة الكاملة."
    },
    examples: [
      "It's five o'clock. - إنها الساعة الخامسة تمامًا.", "The train leaves at half past eight. (8:30) - يغادر القطار في الثامنة والنصف.", "The class starts at a quarter to nine. (8:45) - يبدأ الفصل في التاسعة إلا ربع.", "What time is it? It's ten past three. (3:10) - كم الساعة؟ إنها الثالثة وعشر دقائق.", "My appointment is at two thirty. (2:30) - موعدي في الثانية والنصف."
    ]
  },
  "A1-16": {
    explanation: {
      ...
      ar: "نستخدم \"There is\" و \"There are\" للقول بأن شيئًا ما موجود. تُستخدم \"There is\" مع الأسماء المفردة. تُستخدم \"There are\" مع الأسماء الجمع. في الأسئلة، نعكس الترتيب إلى \"?...Is there\" و \"?...Are there\". الصيغ المنفية هي \"There is not\" و \"There are not\"."
    },
    examples: [
      "There is a book on the table. - يوجد كتاب على الطاولة.", "There are three chairs in the room. - توجد ثلاثة كراسي في الغرفة.", "Is there a supermarket near here? - هل يوجد سوبر ماركت بالقرب من هنا؟", "There isn't any milk in the fridge. - لا يوجد أي حليب في الثلاجة.", "Are there any questions? - هل هناك أي أسئلة؟"
    ]
  },
  "A1-17": {
    explanation: {
      ...
      ar: "يُستخدم الفعل المساعد \"can\" للتعبير عن القدرة أو للقول بأنك تعرف كيفية فعل شيء ما. التركيب بسيط: فاعل + can + الفعل الأساسي. الصيغة المنفية هي \"cannot\" أو \"can't\". شكل \"can\" هو نفسه لجميع الضمائر."
    },
    examples: [
      "I can speak English. - أنا أستطيع تحدث الإنجليزية.", "She can play the piano. - هي تستطيع العزف على البيانو.", "He cannot (can't) swim. - هو لا يستطيع السباحة.", "Can you help me, please? - هل يمكنك مساعدتي من فضلك؟", "They can run very fast. - هم يستطيعون الركض بسرعة كبيرة."
    ]
  },
  "A1-18": {
    explanation: {
      ...
      ar: "نستخدم \"have got\" للحديث عن الملكية، والعلاقات، والأمراض. وهي شائعة جدًا في اللغة الإنجليزية البريطانية. التركيب هو فاعل + have/has + got. تُستخدم \"has got\" مع he, she, it. يتم تشكيل النفي باستخدام \"haven't/hasn't got\"."
    },
    examples: [
      "I have got a new car. - لدي سيارة جديدة.", "She has got blue eyes. - لديها عينان زرقاوان.", "Have you got the time? - هل لديك فكرة عن الوقت؟", "He hasn't got any brothers. - ليس لديه أي إخوة.", "We have got a meeting at 3 PM. - لدينا اجتماع في الساعة 3 مساءً."
    ]
  },
  "A1-19": {
    explanation: {
      ...
      ar: "تعلم مفردات أفراد العائلة يساعدك على تقديم عائلتك والتحدث عنها. تشمل الكلمات الأساسية: mother (أم)، father (أب)، sister (أخت)، brother (أخ)، son (ابن)، و daughter (ابنة). نستخدم صفات الملكية مثل \"my\" و \"his\" لإظهار العلاقات (مثال: 'my mother')."
    },
    examples: [
      "My father is a teacher. - أبي معلم.", "Her mother is from Casablanca. - والدتها من الدار البيضاء.", "I have one brother and two sisters. - لدي أخ واحد وأختان.", "This is my son, Omar. - هذا ابني عمر.", "His daughter is five years old. - ابنته تبلغ من العمر خمس سنوات."
    ]
  },
  "A1-20": {
    explanation: {
      ...
      ar: "يغطي هذا الدرس المفردات الأساسية للأطعمة والمشروبات الشائعة. تعلم هذه الكلمات مفيد للتسوق، والطلب في مطعم، أو التحدث عن وجباتك. تشمل الأمثلة: water (ماء)، bread (خبز)، apple (تفاحة)، cheese (جبن)، و coffee (قهوة)."
    },
    examples: [
      "I drink coffee every morning. - أشرب القهوة كل صباح.", "She likes to eat cheese and bread. - هي تحب أن تأكل الجبن والخبز.", "Can I have a glass of water, please? - هل يمكنني الحصول على كوب من الماء من فضلك؟", "An apple a day keeps the doctor away. - تفاحة في اليوم تبقي الطبيب بعيدًا.", "My favorite food is pizza. - طعامي المفضل هو البيتزا."
    ]
  },
  "A1-21": {
    explanation: {
      ...
      ar: "يصف زمن المضارع المستمر الأفعال التي تحدث الآن، في هذه اللحظة. نكوّنه باستخدام فعل \"to be\" (am, is, are) + الفعل الرئيسي مع إضافة \"-ing\" في نهايته. كما أنه يستخدم للحالات المؤقتة أو الخطط المستقبلية المؤكدة."
    },
    examples: [
      "You are learning English now. - أنت تتعلم الإنجليزية الآن.", "I am reading a book. - أنا أقرأ كتابًا.", "She is talking on the phone. - هي تتحدث على الهاتف.", "They are watching television. - هم يشاهدون التلفاز.", "He isn't sleeping; he's working. - هو ليس نائمًا؛ إنه يعمل."
    ]
  },
  "A1-22": {
    explanation: {
      ...
      ar: "الأسماء المعدودة هي الأشياء التي يمكننا عدها باستخدام الأرقام (مثال: تفاحة واحدة، تفاحتان). الأسماء غير المعدودة هي الأشياء التي لا يمكننا عدها بالأرقام (مثال: ماء، أرز، مال). نستخدم \"a/an\" وصيغ الجمع مع الأسماء المعدودة، ولكن ليس مع الأسماء غير المعدودة."
    },
    examples: [
      "I have three pencils. (countable) - لدي ثلاثة أقلام رصاص. (معدود)", "She needs some information. (uncountable) - هي تحتاج بعض المعلومات. (غير معدود)", "There is a book on the table. (countable) - يوجد كتاب على الطاولة. (معدود)", "Can I have some water? (uncountable) - هل يمكنني الحصول على بعض الماء؟ (غير معدود)", "He eats rice every day. (uncountable) - هو يأكل الأرز كل يوم. (غير معدود)"
    ]
  },
  "A1-23": {
    explanation: {
      ...
      ar: "نستخدم \"some\" و \"any\" مع الأسماء المعدودة الجمع والأسماء غير المعدودة. تُستخدم \"Some\" بشكل عام في الجمل المثبتة. تُستخدم \"Any\" بشكل عام في الجمل المنفية والأسئلة. تشير كلتاهما إلى كمية غير محددة."
    },
    examples: [
      "I have some books. - لدي بعض الكتب.", "She wants some coffee. - هي تريد بعض القهوة.", "I don't have any money. - ليس لدي أي مال.", "Are there any chairs? - هل هناك أي كراسي؟", "There isn't any sugar. - لا يوجد أي سكر."
    ]
  },
  "A1-24": {
    explanation: {
      ...
      ar: "تصف ظروف التكرار عدد المرات التي يحدث فيها الفعل. من الأمثلة عليها: \"always\" (دائمًا)، \"usually\" (عادةً)، \"often\" (غالبًا)، \"sometimes\" (أحيانًا)، \"rarely\" (نادرًا)، و \"never\" (أبدًا). توضع عادةً قبل الفعل الرئيسي، ولكن بعد فعل \"to be\"."
    },
    examples: [
      "I always drink tea in the morning. - أنا دائمًا أشرب الشاي في الصباح.", "She is never late for class. - هي لا تتأخر أبدًا عن الفصل.", "He sometimes plays football with his friends. - هو يلعب كرة القدم أحيانًا مع أصدقائه.", "We usually go to the cinema on Fridays. - نحن عادة نذهب إلى السينما أيام الجمعة.", "They often visit their grandparents. - هم غالبًا يزورون أجدادهم."
    ]
  },
  "A1-25": {
    explanation: {
      ...
      ar: "للحديث عن الماضي باستخدام فعل \"to be\"، نستخدم \"was\" و \"were\". \"Was\" هي صيغة الماضي من \"am\" و \"is\" (تُستخدم مع I, he, she, it). \"Were\" هي صيغة الماضي من \"are\" (تُستخدم مع you, we, they). الصيغ المنفية هي \"wasn't\" و \"weren't\"."
    },
    examples: [
      "I was at home yesterday. - كنت في المنزل بالأمس.", "She was a student last year. - كانت طالبة العام الماضي.", "They were in Paris last week. - كانوا في باريس الأسبوع الماضي.", "He wasn't happy with the results. - لم يكن سعيدًا بالنتائج.", "Were you at the party? - هل كنت في الحفلة؟"
    ]
  },
  "A1-26": {
    explanation: {
      ...
      ar: "يُستخدم زمن الماضي البسيط للحديث عن أفعال مكتملة في الماضي. بالنسبة للأفعال المنتظمة، نكوّن صيغة الماضي بإضافة \"-ed\" إلى الصيغة الأساسية للفعل. الصيغة هي نفسها لجميع الضمائر. لتكوين جمل منفية، نستخدم \"did not\" (didn't) + الفعل الأساسي."
    },
    examples: [
      "I visited my grandmother yesterday. - زرت جدتي بالأمس.", "She played tennis last weekend. - هي لعبت التنس في نهاية الأسبوع الماضي.", "They watched a movie last night. - هم شاهدوا فيلمًا الليلة الماضية.", "He didn't work on Sunday. - هو لم يعمل يوم الأحد.", "Did you study for the exam? - هل درست للامتحان؟"
    ]
  },
  "A1-27": {
    explanation: {
      ...
      ar: "الأفعال غير المنتظمة لا تتبع قاعدة إضافة \"-ed\" لتكوين صيغة الماضي. لديها أشكال ماضية فريدة يجب عليك حفظها. على سبيل المثال، ماضي \"go\" هو \"went\"، وماضي \"see\" هو \"saw\". تستخدم صيغ النفي والسؤال \"did\" تمامًا مثل الأفعال المنتظمة."
    },
    examples: [
      "I went to the market this morning. - ذهبت إلى السوق هذا الصباح.", "She saw a good film yesterday. - هي رأت فيلمًا جيدًا بالأمس.", "We had a great time at the party. - قضينا وقتًا رائعًا في الحفلة.", "He ate a large pizza for lunch. - هو أكل بيتزا كبيرة على الغداء.", "They didn't come to school today. - هم لم يأتوا إلى المدرسة اليوم."
    ]
  },
  "A1-28": {
    explanation: {
    ...
    examples: [
      "She called me yesterday. - هي اتصلت بي بالأمس.", "I saw him at the library. - رأيته في المكتبة.", "He gave the book to her. - هو أعطى الكتاب لها.", "Can you help us? - هل يمكنك مساعدتنا؟", "The teacher wants to speak to them. - المعلم يريد التحدث إليهم."
    ]
  },
  "A1-29": {
    explanation: {
      ...
      ar: "للحديث عن الأنشطة التي تستمتع بها، يمكنك استخدام الفعل \"like\" متبوعًا بفعل آخر في صيغة \"-ing\" (المصدر). هذا التركيب يعبر عن التفضيلات والهوايات العامة. ينطبق نفس النمط على أفعال مثل \"love\", \"enjoy\", و \"hate\"."
    },
    examples: [
      "I like reading books. - أنا أحب قراءة الكتب.", "She loves swimming in the sea. - هي تحب السباحة في البحر.", "He enjoys playing video games. - هو يستمتع بلعب ألعاب الفيديو.", "They hate waiting in long lines. - هم يكرهون الانتظار في طوابير طويلة.", "Do you like listening to music? - هل تحب الاستماع إلى الموسيقى؟"
    ]
  },
  "A1-30": {
    explanation: {
  ...
  "A2-1": {
    explanation: {
      en: "This is a review of the two main present tenses. We use the Present Simple for habits, routines, and facts (e.g., \"I work every day\"). We use the Present Continuous for actions happening right now or temporary situations (e.g., \"I am working now\"). Understanding the difference is key to describing the present accurately.",
  ...
  "A2-2": {
    explanation: {
      en: "The Past Simple describes completed actions in the past. While regular verbs end in '-ed', irregular verbs have unique forms that you must memorize (e.g., go -> went, see -> saw, eat -> ate). In questions and negatives, we use 'did' or 'didn't' with the base form of the verb for both regular and irregular verbs.",
